...
window.onload = prepareTargetBlank;
         ...
         //--><!]]></script>
		 <script type="text/javascript" src="js_lightbox/mootools.js"></script>
	     <script type="text/javascript" src="js_lightbox/slimbox.js"></script>
	     <link rel="stylesheet" href="cssgenerales/slimbox.css" type="text/css" media="screen" />	
		 <script>
  ...
  ga('send', 'pageview');
    ...
    <body id="contacto_pagina" class="consulta" >
    	<div id="principal">
						...
						<div id="menu_uno">
							<ul id="lista_principal">
								...
								<ul id="lista_secundaria">
										<li><a id="boton_listado_actividades" href="actividades.html">seg&uacute;n TIPOS DE ACTIVIDAD</a></li>
  ...
  ?>
				...
				<div id="columna_dos">
					<div id="datos_contacto">
						<p>Turismo Activo de C&oacute;rdoba</p>
						<p>03544-15405957 / 03544-15563650</p>
